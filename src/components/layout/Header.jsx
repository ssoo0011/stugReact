...
export default function Header() {
    ...
    const logout = async () => {
        ...
        if (res.data.code === 'SUCCESS') {
            try {
                await api.get("/api/auth/isLogin"); // 여기서 에러 나면 catch로 감
                setIsAuth(true);
            } catch {
                setIsAuth(false);
            }
                                ...
                                <ul className="navbar-nav nav-pills">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-sm">
                                                    <div className="navbar-dropdown-menu-inner">
                                                        ...
                                                        <a className="dropdown-item active" href="./index.html"><i
                                                            className="bi-building me-2"></i> Corporate</a>
                                                        <a className="dropdown-item " href="./landing-business.html"><i
                                                            className="bi-briefcase me-2"></i> Business <span
                                                            className="badge text-primary">New</span></a>
                                                        <a className="dropdown-item "
                                                           href="./landing-consulting.html"><i
                                                            className="bi-chat-right-dots me-2"></i> Consulting <span
                                                            className="badge text-primary">New</span></a>
                                                        <a className="dropdown-item " href="./landing-saas.html"><i
                                                            className="bi-tropical-storm me-2"></i> SaaS</a>
                                                        <a className="dropdown-item " href="./landing-services.html"><i
                                                            className="bi-gear me-2"></i> Services</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="navbar-dropdown-menu-inner">
                                                <div className="row">
                                                    <div className="col-sm-6 col-lg-3">
                                                        ...
                                                        <a className="dropdown-item "
                                                           href="./page-customer-stories.html">Customer
                                                            Stories</a>
                                                        <a className="dropdown-item " href="./page-customer-story.html">Customer
                                                            Story</a>
                                                        <a className="dropdown-item " href="./page-help-center.html">Help
                                                            Center</a>
                                                        <a className="dropdown-item "
                                                           href="./page-help-center-categories.html">Help Center:
                                                            Categories</a>
                                                        <a className="dropdown-item "
                                                           href="./page-help-center-article.html">Help Center:
                                                            Article</a>
                                                    </div>
                                                    ...
                                                    <div className="col-sm-6 col-lg-3 mt-n5 mt-sm-0 mb-3 mb-lg-0">
                                                        ...
                                                        <a className="dropdown-item "
                                                           href="./page-careers.html">Careers</a>
                                                        <a className="dropdown-item "
                                                           href="./page-careers-role-overview.html">Careers: Role
                                                            Overview</a>
                                                        <a className="dropdown-item " href="./page-careers-apply.html">Careers:
                                                            Apply</a>
                                                        <a className="dropdown-item " href="./page-hire-us.html">Hire
                                                            Us</a>
                                                        <a className="dropdown-item " href="./page-login.html">Log
                                                            In</a>
                                                        <a className="dropdown-item " href="./page-signup.html">Sign
                                                            Up</a>
                                                        <a className="dropdown-item " href="./page-reset-password.html">Forgot
                                                            Password</a>
                                                    </div>
                                                    ...
                                                    <div className="col-sm-6 col-lg-3 mb-3 mb-lg-0">
                                                        ...
                                                        <a className="dropdown-item "
                                                           href="./portfolio-modern.html">Modern</a>
                                                        <a className="dropdown-item "
                                                           href="./portfolio-case-study.html">Case
                                                            Study</a>
                                                    </div>
                                                    ...
                                                    <div className="col-sm-6 col-lg-3">
                                                        ...
                                                        <a className="dropdown-item "
                                                           href="./page-pricing.html">Pricing</a>
                                                        <a className="dropdown-item "
                                                           href="./page-contacts.html">Contacts</a>
                                                        <a className="dropdown-item " href="./page-coming-soon.html">Coming
                                                            Soon</a>
                                                        <a className="dropdown-item "
                                                           href="./page-coming-soon-simple.html">Coming
                                                            Soon: Simple</a>
                                                        <a className="dropdown-item " href="./page-error-404.html">Error
                                                            404</a>
                                                        <a className="dropdown-item "
                                                           href="./page-terms.html">Terms &amp; Conditions</a>
                                                        <a className="dropdown-item "
                                            ...
                                            <div className="row">
                                                            ...
                                                            <div className="col-md-6 mb-3 mb-md-0">
                                                                <a className="d-block"
                                                                   href="./documentation/index.html">
                                                                    <img className="img-fluid rounded-2 mb-2"
                                                                         src="./assets/svg/components/card-1.svg"
                                                                         alt="Image Description"/>

                                                                    <span
                                                                        className="fs-4 fw-medium text-dark text-inherit">Documentation</span>
                                                                    <p className="fs-6 text-body">Development guides for
                                                                        building projects with Unify</p>
                                                                    <span
                                                                        className="link link-pointer">Learn more</span>
                                                                </a>
                                                            </div>

                                                            <div className="col-md-6">
                                                                <a className="d-block" href="./snippets/index.html">
                                                                    <img className="img-fluid rounded-2 mb-2"
                                                                         src="./assets/svg/components/card-2.svg"
                                                                         alt="Image Description"/>

                                                                    <span
                                                                        className="fs-4 fw-medium text-dark text-inherit">Snippets</span>
                                                                    <p className="fs-6 text-body">Move quickly with
                                                ...
                                                <div className="col-lg-4">
                                                    <div className="navbar-dropdown-menu-inner">
                                                        <span className="dropdown-header">Classic</span>
                                                        <a className="dropdown-item "
                                                           href="./blog-modern.html">Modern <span
                                                            className="badge text-primary">New</span></a>
                                                        <a className="dropdown-item " href="./blog-grid.html">Grid</a>
                                                        <a className="dropdown-item " href="./blog-list.html">List</a>
                                                        <a className="dropdown-item "
                                                           href="./blog-article.html">Article <span
                                                            className="badge text-primary">New</span></a>
                                                        <a className="dropdown-item " href="./blog-author-profile.html">Author
                                                            Profile</a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li className="hs-has-mega-menu nav-item"
                                        ...
                                        <div className="hs-mega-menu hs-position-right-fix dropdown-menu"
                                            ...
                                            <a className="navbar-dropdown-menu-media-link"
                                               href="./documentation/index.html">
                                                <div className="d-flex">
                                                    ...
                                                    <span
                                                        ...
                                                        <p className="navbar-dropdown-menu-media-desc">Development
                                                            guides
                                            ...
                                            <a className="navbar-dropdown-menu-media-link" href="./snippets/index.html">
                                                <div className="d-flex">
                                                    <div className="flex-shrink-0">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <span
                                                            className="navbar-dropdown-menu-media-title">Snippets</span>
                                    ...
                                    <li className="nav-item ms-lg-auto">
                                        {isAuth ?
                                            (
                                                <a className="btn btn-ghost-dark me-2 me-lg-0"
                                    ...
                                    <li className="nav-item">
                                        {isAuth ?
                                            (
                                                <a className="btn btn-primary d-lg-inline-block"
                                                   onClick={() => navigate("/myPage")}>my Page</a>
                                            ) :
                                            (
                                                <a className="btn btn-primary d-lg-inline-block"
                                                   onClick={() => navigate("/user/signUp")}>signUp</a>
                                            )
                                        }
                                    </li>
                                </ul>
